    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12 text-center">
          <h1 className="mb-4">About the Ramalan Family</h1>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Preserving our heritage, strengthening our unity, and guiding future generations.
          </p>
        </div>

        {/* Islamic Greeting */}
        <section className="mb-16 text-center">
          <div className="bg-muted rounded-xl p-8 md:p-10">
            <p className="text-xl md:text-2xl font-medium mb-4">
              Assalamu Alaikum Wa Rahmatullahi Wa Barakatuh
            </p>
            <p className="text-muted-foreground max-w-3xl mx-auto">
              May Allah bless our family and guide us always.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="bg-card rounded-xl p-8 md:p-12 shadow-sm border border-border">
            ...
            <div className="prose max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Today, the Ramalan family spans generations across different locations, continuing to uphold
                the values of togetherness, faith, and service to society.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="bg-card rounded-xl p-8 md:p-12 shadow-sm border border-border text-center">
            <h2 className="mb-6">Our Mission</h2>
            <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              To foster unity, preserve our rich family history, support one another in education and welfare,
              and promote positive contributions to society. We organize annual gatherings, such as our cherished
              family meetings and Walimah, to strengthen bonds, share knowledge, and celebrate our shared identity.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="bg-muted rounded-xl p-8 md:p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              A thriving, interconnected family that honors its past while empowering future generations
              to lead with excellence and compassion.
            </p>
          </div>
        </section>
            ...
            {[
              {
                ...
                title: 'Unity & Togetherness',
                description:
                  'We believe in the strength of family bonds and the importance of staying connected, supporting one another in all of life’s moments.',
              },
              {
                icon: TreePine,
                title: 'Heritage Preservation',
                description:
                  'We honor our ancestors by preserving and passing down our family history, traditions, and values.',
              },
              {
                icon: Users,
                title: 'Respect & Care',
                description:
                  'We show respect to our elders, nurture the young, and treat all family members with kindness.',
              },
              {
                icon: BookOpen,
                title: 'Education & Growth',
                description:
                  'We encourage learning, personal development, and excellence grounded in strong moral values.',
              },
            ].map((value) => {
              const Icon = value.icon;
              return (
